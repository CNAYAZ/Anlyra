...
| Auth (planned) | NextAuth v5 (Google + Microsoft + email/password + 2FA) |
...
- ✅ Design system custom 5/5 fasi (palette panna+sage, 14 componenti restilizzati)
- ✅ i18n IT/EN allineato (1556+ chiavi)
...
- 🚧 FASE D: NextAuth reale + signup + email verify + 2FA
...
Clicca **"Accedi con demo"** sulla pagina di login — nessuna credenziale richiesta. Il pulsante fa POST a `/api/auth/login-demo`.
...
│   ├── lib/
│   │   ├── auth/                  # Auth utilities (demo cookie + planned NextAuth)
