 ...
 * Esegue parsing CSV, auto-mapping e validazione su ENTRAMBE le fixture
 * (formato semplice e formato estratto conto bancario italiano), SENZA DB.
 *
...
runFixture('import-sample.csv');
runFixture('movimenti_bancari_esempio.csv');
