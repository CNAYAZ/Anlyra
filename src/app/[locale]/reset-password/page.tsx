...
const COPY = {
  it: {
    ...
    saving: 'Salvataggio…',
    success: 'Password aggiornata: tutti i dispositivi collegati sono stati disconnessi. Ora puoi accedere.',
  ...
  en: {
    ...
    saving: 'Saving…',
    success: 'Password updated: every signed-in device has been signed out. You can now sign in.',
    goLogin: 'Go to login',
