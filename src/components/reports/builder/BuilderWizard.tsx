    ...
    <div className="grid gap-6 lg:grid-cols-[1fr_320px]">
      <div className="space-y-6">
        <div className="card">
          ...
          {error && (
            <div className="mt-4 rounded-lg bg-danger/10 border border-danger px-3 py-2 text-sm text-danger">
              {error}
            </div>
          )}
...
function Step1({
  ...
  return (
    <div>
      <h2 className="font-heading font-semibold text-foreground">{tBuilder('step1.title')}</h2>
      <p className="text-sm text-muted-foreground mt-1">{tBuilder('step1.description')}</p>
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between">
                <div className="font-medium text-foreground">{tType(type)}</div>
...
function Step2({
  ...
  return (
    <div>
      <h2 className="font-heading font-semibold text-foreground">{tBuilder('step2.title')}</h2>
      <p className="text-sm text-muted-foreground mt-1">{tBuilder('step2.description')}</p>
...
function Step3({
  ...
  return (
    <div>
      <h2 className="font-heading font-semibold text-foreground">{tBuilder('step3.title')}</h2>
      <p className="text-sm text-muted-foreground mt-1">{tBuilder('step3.description')}</p>
        ...
        {all.map((s) => {
          ...
          return (
            ...
            >
              ...
              />
              <span className="text-sm font-medium text-foreground">{tSection(s)}</span>
            </label>
          );
        })}
      </div>
...
function Step4({
  ...
  return (
    <div>
      <h2 className="font-heading font-semibold text-foreground">{tBuilder('step4.title')}</h2>
      <p className="text-sm text-muted-foreground mt-1">{tBuilder('step4.description')}</p>
        ...
        <div className="flex items-center justify-between rounded-lg border border-border p-3">
          ...
          <button
            ...
            className={`relative h-6 w-11 rounded-full transition-colors ${
              includeCharts ? 'bg-primary-accent' : 'bg-muted-foreground/30'
            }`}
          >
            <span
