      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <select
            ...
            disabled={pending}
            className="w-full rounded-md border border-slate-300 px-3 py-2 text-sm focus:border-primary-accent focus:outline-none focus:ring-1 focus:ring-primary-accent"
          >
            {FREQUENCIES.map((f) => (
