      ...
      toastOptions={{
        classNames: {
          toast: [
            ...
            '!border-l-[3px] grid grid-cols-[30px_1fr_auto] gap-3 p-3 pl-3.5 items-start',
          ].join(' '),
          title: 'text-[13px] font-semibold text-foreground tracking-tight',
          description: 'text-[12.5px] text-fg-2 leading-snug mt-0.5',
          actionButton: 'text-[12px] font-medium text-sage-700 dark:text-sage-300 hover:underline',
